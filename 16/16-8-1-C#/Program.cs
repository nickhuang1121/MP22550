...
void loadRom()
{
    var fs = new FileStream("./PONG", FileMode.Open);
...
void chip8SpriteMove()
{
    ...
    if (Raylib.IsKeyUp(KeyboardKey.Two))
    {
        Keyboard[2] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.Three))
    {
        Keyboard[3] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.Four))
    {
        Keyboard[12] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.Q))
    {
        Keyboard[4] = false;
    }
    ...
    if (Raylib.IsKeyUp(KeyboardKey.E))
    {
        Keyboard[6] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.R))
    {
        Keyboard[13] = false;
    }
    ...
    if (Raylib.IsKeyUp(KeyboardKey.S))
    {
        Keyboard[8] = false;
    }
    ...
    if (Raylib.IsKeyUp(KeyboardKey.F))
    {
        Keyboard[14] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.Z))
    {
        Keyboard[10] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.X))
    {
        Keyboard[0] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.C))
    {
        Keyboard[11] = false;
    }
    if (Raylib.IsKeyUp(KeyboardKey.V))
    {
        Keyboard[15] = false;
    }
}
